  ...
  const [error, setError] = useState("");
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const response = await axios.put(`http://localhost:5000/user/update/${currentUser.id}`, {
				name,
				email,
				password,
			});
      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex items-center mb-6 space-x-20">
            ...
            <div className="flex justify-center">
              <button className="w-full px-8 py-2 text-white bg-gray-700 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500">
                Change Avatar
              </button>
            </div>
          </div>
