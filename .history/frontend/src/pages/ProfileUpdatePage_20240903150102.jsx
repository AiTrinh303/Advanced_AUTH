...
const ProfileUpdatePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(`http://localhost:5000//user/update/${currentUser.id}`, {
        username,
        email,
        password,
        avatar:avatar[0],
            ...
            <div className="flex items-center justify-start mb-6 space-x-20">
              <div className="flex justify-center items-center">
                <img
                  ...
                  src=src={avatar[0] || currentUser.avatar || "/noavatar.jpg"}
                  alt=""
                />
              </div>
              <div className="flex justify-center items-center">
                <button className="w-full px-4 py-2 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                  Change Avatar
                </button>
              </div>
            </div>
