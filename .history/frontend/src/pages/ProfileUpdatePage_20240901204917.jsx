      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            <Stack direction="row" spacing={20} align="center" className="mb-6">
              <Center>
                <Avatar boxSize="90px" className="mr-6 rounded-full bg-gray-700" src="" name="avatar"/>
              </Center>
              <Center>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="text-gray-300 mb-4">
              <label htmlFor="email" className="block mb-2 font-medium" name="avatar">Email</label>
              <input
                name="email"
                type="email"
