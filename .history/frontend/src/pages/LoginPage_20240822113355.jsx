...
const LoginPage = () => {
	...
	const { login, isLoading, error, google,  } = useAuthStore();
	...
	// const github = () => {
	// 	  window.open("http://localhost:5000/auth/login/github", "_self");
	// 	};
	  
	// const facebook = () => {
	// 	  window.open("http://localhost:5000/auth/login/facebook", "_self");
	// 	};
