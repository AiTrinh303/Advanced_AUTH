...
export const useAuthStore = create((set) => ({
	...
	checkAuth: async () => {
		...
		try {
			...
			set({ 
				user: response.data.user, 
				isAuthenticated: true, isCheckingAuth: false });
		} 
		catch (error) {
	...
	checkAuthAdmin: async () => {
		...
		try {
			...
			set({ user: response.data.admin, isAdmin: true, isCheckingAdmin: false });
		}
		catch (error) {
			set({ error: null, isAdmin: false, isCheckingAdmin: false });
		}
	},
