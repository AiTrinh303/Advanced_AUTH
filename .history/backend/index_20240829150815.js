...
app.use(
	session({
		...
		store: MongoStore.create({
			mongoUrl: 'mongodb+srv://trongtrinh:Dci1234!@clusterai.tlcycev.mongodb.net/Auth2?retryWrites=true&w=majority&appName=ClusterAi', // Use your actual MongoDB connection string
