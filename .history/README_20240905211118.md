...
This project provides a complete authentication system using the MERN stack (MongoDB, Express, React, Node.js) with advanced features including email verification (NODEMAILER), social logins (PASS), password recovery.
