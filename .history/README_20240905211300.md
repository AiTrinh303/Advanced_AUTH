...
This project provides a complete authentication system using the MERN stack (MongoDB, Express, React, Node.js) with advanced features including Email verification (NODEMAILER), social logins (PASSPORTJS), password recovery (TOKEN, COOKIE) and much more!
